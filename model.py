...
class Actor(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, fc1_units=512, fc2_units=256, fc3_units=256):
        ...
        self.batch_norm1 = nn.BatchNorm1d(fc1_units)       # Use batch normalization 
...
class Critic(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, fcs1_units=510, fc2_units=256, fc3_units=256):
        """Initialize parameters and build model.
        Params
        ======
            state_size (int): Dimension of each state
